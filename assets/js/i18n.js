...
const translations = {
  es: {
    ...
    about: {
      ...
      dicelDesc: 'Lideré la migración de sistemas de Facturación Electrónica utilizando Oracle, PL/SQL Forms y Apex.<br>Proyecto a cargo: migración, actualización y mantenimiento del Sistema de Gestión de Información Comercial (S.G.I.C.) y del Sistema de Gestión de Información Financiera (S.G.I.F.).',
  ...
  en: {
    ...
    about: {
      ...
      dicelDesc: 'Led the migration of Electronic Invoicing systems using Oracle, PL/SQL Forms, and Apex.<br>Project in charge: migration, update, and maintenance of the Commercial Information Management System (S.G.I.C.) and the Financial Information Management System (S.G.I.F.).',
